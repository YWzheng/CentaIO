...
public class Callback implements Window.Callback{
    private final Window.Callback callback;
    private final Activity activity;

    Callback(Activity activity, Window.Callback callback){
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        CentaIO.getInstance().dispatchTouchEvent(this.activity,event);
